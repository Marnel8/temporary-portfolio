...
export default function StageVersus({
	...
	return (
		<div ref={scope} className="fixed inset-0 z-40 flex items-stretch overflow-hidden bg-[#0A0E14]">
			<div className="vs-left relative flex-1 bg-gradient-to-br from-[#00E5C7]/20 to-transparent">
				<Image src={DATA.avatarUrl} alt={DATA.name} fill className="object-cover object-top opacity-60" sizes="50vw" />
				<div className="absolute bottom-10 left-8 font-display text-5xl font-bold text-[#E4E7EB] sm:text-7xl">MARNEL</div>
			</div>
			<div className="vs-right relative flex-1 bg-gradient-to-bl from-[#ff5a3c]/20 to-transparent">
				...
				<div className="absolute bottom-10 right-8 text-right font-display text-5xl font-bold text-[#E4E7EB] sm:text-7xl">{opp.name}</div>
			</div>
			<div className="vs-badge absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-display text-8xl font-black italic text-[#E4E7EB] drop-shadow-[0_0_30px_rgba(255,90,60,0.7)]">
				VS
			</div>
