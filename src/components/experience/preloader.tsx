...
export default function Preloader() {
	...
	return (
		<div
			ref={root}
			className="fixed inset-0 z-[100] flex flex-col justify-between bg-[#070809] p-6 sm:p-10"
		>
			...
			<div className="relative h-px w-full bg-white/10">
				<div
					ref={bar}
					className="h-full origin-left scale-x-0 bg-[hsl(222,96%,64%)]"
				/>
			</div>
		</div>
	);
